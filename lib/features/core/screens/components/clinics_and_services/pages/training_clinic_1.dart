...
class TrainingClinic2 extends StatefulWidget {
  const TrainingClinic2({super.key});

  @override
  State<TrainingClinic2> createState() => _TrainingClinic2State();
}

class _TrainingClinic2State extends State<TrainingClinic2> {
  @override
