// ignore_for_file: prefer_const_constructors, unused_field, prefer_final_fields, sort_child_properties_last, sized_box_for_whitespace, no_leading_underscores_for_local_identifiers
...
class VetClinic1 extends StatefulWidget {
  const VetClinic1({super.key});

  @override
  State<VetClinic1> createState() => _VetClinicState();
}

class _VetClinicState extends State<VetClinic1> {
  @override
  Widget build(BuildContext context) {
    List<VeterinaryClinic> _vetList = VeterinaryClinic.veterinaryList1;
    return Scaffold(
      appBar: AppBar(
