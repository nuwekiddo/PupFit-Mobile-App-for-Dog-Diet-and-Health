...
class VetClinic2 extends StatefulWidget {
  const VetClinic2({super.key});

  @override
  State<VetClinic2> createState() => _VetClinicState();
}

class _VetClinicState extends State<VetClinic2> {
  @override
  Widget build(BuildContext context) {
    List<VeterinaryClinic> _vetList = VeterinaryClinic.veterinaryList2;
    return Scaffold(
      appBar: AppBar(
